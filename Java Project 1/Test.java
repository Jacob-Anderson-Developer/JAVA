...
public class Test
{
	...
	int credits;
	final double tuitionRate = 503.95, facilityFee = 10.00, parkingFee = 60.75, registrationFee = 45.00;
	...
	tuitionRateTot = tuitionRate * credits;
	facilityFeeTot = facilityFee * credits;
	parkingFeeTot = parkingFee * credits;
	registrationFeeTot = registrationFee * credits;
